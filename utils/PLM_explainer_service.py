...
def predict_explain(
    ...
    if "icd10" in model_path_lower:
        description_path = "data/code_descriptions/icd10.json"
    elif "icd9" in model_path_lower:
        description_path = "data/code_descriptions/icd9.json"
    else:
        # Default fallback to original path if version cannot be determined
        description_path = "data/code_descriptions/icd9.json"
        logger.warning(
